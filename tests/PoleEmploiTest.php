...
class PoleEmploiTest extends TestCase
{
    ...
    private function getCodeRome(String $libellé): Array
    {
        ...
        try{
            curl_setopt($ch, CURLOPT_URL, "https://api.emploi-store.fr/partenaire/rome/v1/appellation?qf=libelle&limit=1&q=".urlencode($libellé));
    ...
    {
        print_r($this->getCodeRome("Jardinier paysagiste")[0]);
